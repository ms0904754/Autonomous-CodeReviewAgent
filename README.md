...
* **AI-Powered Code Analysis:** Leverages **Google Gemini 1.5 Flash** (via Spring AI) to review code changes for performance bottlenecks, time/space complexity, and code smells.
